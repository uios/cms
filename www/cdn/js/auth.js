window.auth = {
    config: {
        apiKey: "AIzaSyBbQonEShNBX-ryVzNhvaq71gmeaBBdTFM",
        authDomain: "cmsjs-fd510.firebaseapp.com",
        projectId: "cmsjs-fd510",
        messagingSenderId: "15426504387",
        appId: "1:15426504387:web:e30a96fe3b283f03a48476",
        measurementId: "G-3BGDKY23GM"
    },
    change: user => { console.log('auth.js auth.change', auth.online());
        ...
        if(window.location.pathname === "/") { '/'.router({reload:true}); }
    },
    framework: (framework) => { return framework.isauth && auth.online() ? 'isauth' : 'noauth'},
